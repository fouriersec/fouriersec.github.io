...
### Initialisation
![initialisation](/assets/sapphire-project/init.png){:target="\_blank"}
...
### Note-taking
![notes](/assets/sapphire-project/note.png){:target="\_blank"}
...
![setenv](/assets/sapphire-project/setenv.png){:target="\_blank"}
...
### Shell execution
![exec](/assets/sapphire-project/exec.png){:target="\_blank"}
...
### Target management
![tmanage](/assets/sapphire-project/delete.png){:target="\_blank"}
...
![reopen](/assets/sapphire-project/reopen.png){:target="\_blank"}
